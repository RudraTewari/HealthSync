  ...
  return (
    <form className="w-full grid grid-cols-12 gap-5 p-4 mt-10" onSubmit={handleSubmit(onSubmit)}>
      ...
      {fields.map((field, index) => (
        <React.Fragment key={field.id}>
          ...
          <div className="col-span-12 flex justify-end mt-1">
            {fields.length > 1 && (
              <Button variant="destructive" size="sm" onClick={() => remove(index)} className="flex items-center gap-1">
      ...
      <div className="col-span-12 flex justify-start mt-2">
        <Button type="button" variant="outline" onClick={() => append({ name: '', dosage: '', frequency: '' })} className="flex items-center gap-1">
      ...
      <div className="col-span-12 mt-10 flex justify-center">
        <Button className="bg-amber-100 text-slate-950 px-7 hover:text-amber-100" type="submit">
          Save
        </Button>
      </div>
    </form>
