        ...
        <div className="w-full min-h-screen grid grid-cols-12">
          ...
          <div className="col-span-10 bg-slate-900 h-full flex flex-col">
            ...
            <div className="flex-1 mx-2 my-2 bg-slate-950 rounded-md p-4">
              ...
              <div className="w-full grid grid-cols-[10%_20%_25%_10%_15%_15%] justify-evenly border-b font-semibold border-gray-700 hover:bg-slate-600   hover:text-slate-300 transition-all duration-300 text-gray-400 text-[15px] py-4">
              ...
              <div className="w-full grid grid-cols-[10%_20%_10%_10%_15%_15%] justify-evenly border-b border-gray-800  hover:bg-slate-600 hover:text-slate-300 transition-all duration-300 py-5 text-sm text-gray-300 ">
                <div className="text-center">CLM-001</div>
                <div className="text-center">Rishab Patel</div>
                <div className="text-center">Blue Cross Blue Shield</div>
                <div className="text-center">2025-08-10</div>
                <div className="text-center">$180,000</div>
