...
const Sidebar = () => {
  return (
    <>
      <div className='w-full h-full bg-[#001C30] flex flex-col'>
          {/* Sidebar Top */}
          <div className='w-full rounded-b-lg'>
              <img src={Logo} alt={Logo} width={100} height={100} className=' rounded-2xl mx-auto mt-6  hover:scale-110 transition-all duration-500 ease-in '></img>
