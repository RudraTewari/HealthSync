...
import CreatePrescript from './CreatePrescript'
          ...
          <div className="col-span-10 bg-slate-900 h-full flex flex-col">
            ...
            <div className="flex justify-between items-center px-7 pt-4 text-gray-300 font-semibold">
              <div className="flex flex-col justify-start gap-2 text-[30px] mt-3 ml-4">
                ...
                <p className="text-[20px] text-gray-500 pb-2">Manage patient prescriptions and medications. </p>
            ...
            <div className="flex-1 mx-2 my-2 bg-slate-950 rounded-md p-4">              
                <div className="flex flex-col gap-2 ml-3">
                  ...
                  <p className="text-[15px] font-semibold text-gray-400 pb-5">View and manage all patient prescriptions.</p>
                </div>
                <div className="w-full grid grid-cols-[20%_15%_10%_10%_25%] justify-evenly border-b font-semibold border-gray-700 hover:bg-slate-600   hover:text-slate-300 transition-all duration-300 text-gray-400 text-[15px] py-4">
                  <div>Patient </div>
                  <div>Doctor</div>
                  <div>Date</div>
                  <div>Status</div>
                ...
                <div className="w-full grid grid-cols-[20%_15%_10%_10%_25%] justify-evenly border-b border-gray-800  hover:bg-slate-600 hover:text-slate-300 transition-all duration-300 py-5 text-sm text-gray-300 ">
                  <div>Jane Smith</div>
                  <div>Dr. Rishab Patel</div>
                  <div>2025-08-10</div>
                  <div>Active</div>
